...
const DUMMY_USERS: User[] = [
  ...
  { id:'u007', full_name:'Sekou Traore',     email:'sekou.t@cacaomonitor.ml',         region:'Mali - South',         role:'Field Agent', status:'suspended', joined_at:'2023-02-28', scan_count:45  },
  ...
  { id:'u013', full_name:'Moussa Kone',      email:'moussa.kone@cacaomonitor.ci',     region:'Ivory Coast - Center', role:'Field Agent', status:'suspended', joined_at:'2022-09-30', scan_count:22  },
